...
function interact(x, y)
  ...
  if check_flag(4, p.x, p.y) and (collision(p, m1) or collision(p, m2)) then
	...
	-- messages
	if x == 2 and y == 2 then
		create_msg("tuto","x to interact","o for axe attack","keys unlock doors")
	end

	if x == 9 and y == 2 then
		create_msg("alyssa", "hello\n", "welcome to piko kingdom", "smallest one there is")
	end
	if x == 25 and y == 24 then
		create_msg("max", "the evil plants\n", "they are killing the land", "save the plants !")
	end
if x == 116 and y == 57 then
		create_msg("hint", "seven league boots", "press x/v with a direction"," to teleport", "cross gap,holes","even thin walls !")
	end
if x == 122 and y == 57 then
		create_msg("hint", "cut down evil sprouts", "10 will open the way to the boss","good luck!")
	end
if x ==126 and y == 60 then
		create_msg("panneau", "anciant ruins", "watch out for dark plants")
	end	
	...
	if x == 3 and y == 62 then
		create_msg("panneau", "unfinished zone go back!")
	end
if x == 46 and y == 53 then
		create_msg("hint", "boss room ahead","did you cut destroy 10 evil sprouts?")
	end
...
b2101010101010060606060606101006b2b210100000000000000000000000005460604772557247606060606010505454454545454500004545000000000000
...
000000000000000000000000763790904790909047760000000000000000000000000000000000000000454545454545454590276190c1909090619090454545
...
b250b250070750b2b200000000000000000000000000000000000000000000005460606060606060606060606060605454454545450000000000000000000000
...
0000000000000000000000007676767656767676767700000000000000000000000000000000000000004507e0b0d0c145459090909090c19090909090906145
...

...

